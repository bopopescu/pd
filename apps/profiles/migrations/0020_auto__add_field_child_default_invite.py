...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Child.default_invite'
        db.add_column('profiles_child', 'default_invite', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='', null=True, to=orm['playdates.InviteDesign']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Child.default_invite'
        db.delete_column('profiles_child', 'default_invite_id')
