...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Friendship.from_user'
        db.add_column('profiles_friendship', 'from_user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='+', to=orm['auth.User']), keep_default=False)

        # Adding field 'Friendship.to_user'
        db.add_column('profiles_friendship', 'to_user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='+', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Friendship.from_user'
        db.delete_column('profiles_friendship', 'from_user_id')

        # Deleting field 'Friendship.to_user'
        db.delete_column('profiles_friendship', 'to_user_id')
    ...
    models = {
        ...
        'schools.school': {
            ...
            'gsid': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'primary_key': 'True'}),
