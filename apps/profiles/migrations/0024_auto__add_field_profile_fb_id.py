...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.fb_id'
        db.add_column('profiles_profile', 'fb_id', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=150, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.fb_id'
        db.delete_column('profiles_profile', 'fb_id')
    ...
    models = {
        ...
        'profiles.profile': {
            ...
            'fb_id': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '150', 'blank': 'True'}),
