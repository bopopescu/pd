...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Child.summer_camp'
        db.add_column('profiles_child', 'summer_camp', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Child.summer_camp'
        db.delete_column('profiles_child', 'summer_camp')
