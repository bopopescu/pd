...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.school_display'
        db.add_column('profiles_profile', 'school_display', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.school_display'
        db.delete_column('profiles_profile', 'school_display')
