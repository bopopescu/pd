...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.source'
        db.alter_column('profiles_profile', 'source', self.gf('django.db.models.fields.CharField')(max_length=150))


    def backwards(self, orm):
        
        # Changing field 'Profile.source'
        db.alter_column('profiles_profile', 'source', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))
