...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_profile', 'photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Photo'], null=True, blank=True), keep_default=False)

        # Adding field 'Profile.album'
        db.add_column('profiles_profile', 'album', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Album'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.photo'
        db.delete_column('profiles_profile', 'photo_id')

        # Deleting field 'Profile.album'
        db.delete_column('profiles_profile', 'album_id')
    ...
    models = {
        ...
        'photos.album': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'albums'", 'to': "orm['auth.User']"}),
