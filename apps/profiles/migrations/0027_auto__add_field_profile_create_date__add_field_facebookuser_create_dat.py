...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.create_date'
        db.add_column('profiles_profile', 'create_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True), keep_default=False)

        # Adding field 'FacebookUser.create_date'
        db.add_column('profiles_facebookuser', 'create_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True), keep_default=False)

        # Adding field 'Child.create_date'
        db.add_column('profiles_child', 'create_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.create_date'
        db.delete_column('profiles_profile', 'create_date')

        # Deleting field 'FacebookUser.create_date'
        db.delete_column('profiles_facebookuser', 'create_date')

        # Deleting field 'Child.create_date'
        db.delete_column('profiles_child', 'create_date')
