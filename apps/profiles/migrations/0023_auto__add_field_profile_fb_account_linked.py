...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.fb_account_linked'
        db.add_column('profiles_profile', 'fb_account_linked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.fb_account_linked'
        db.delete_column('profiles_profile', 'fb_account_linked')
