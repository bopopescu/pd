...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Child.photo'
        db.add_column('profiles_child', 'photo', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['photos.Photo'], null=True, blank=True), keep_default=False)

        # Adding field 'Child.album'
        db.add_column('profiles_child', 'album', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Album'], null=True, blank=True), keep_default=False)

        # Adding field 'Child.calendar'
        db.add_column('profiles_child', 'calendar', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.Calendar'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Child.photo'
        db.delete_column('profiles_child', 'photo_id')

        # Deleting field 'Child.album'
        db.delete_column('profiles_child', 'album_id')

        # Deleting field 'Child.calendar'
        db.delete_column('profiles_child', 'calendar_id')
