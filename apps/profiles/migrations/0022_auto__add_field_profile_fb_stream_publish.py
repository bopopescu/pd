...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.fb_stream_publish'
        db.add_column('profiles_profile', 'fb_stream_publish', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.fb_stream_publish'
        db.delete_column('profiles_profile', 'fb_stream_publish')
