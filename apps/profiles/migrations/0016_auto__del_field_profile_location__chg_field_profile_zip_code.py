...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('profiles_profile', 'location')

        # Renaming column for 'Profile.zip_code' to match new field type.
        db.rename_column('profiles_profile', 'zip_code', 'zip_code_id')
        # Changing field 'Profile.zip_code'
        db.alter_column('profiles_profile', 'zip_code_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Zip'], null=True))


    def backwards(self, orm):
        
        # Adding field 'Profile.location'
        db.add_column('profiles_profile', 'location', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True), keep_default=False)

        # Renaming column for 'Profile.zip_code' to match new field type.
        db.rename_column('profiles_profile', 'zip_code_id', 'zip_code')
        # Changing field 'Profile.zip_code'
        db.alter_column('profiles_profile', 'zip_code', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))
