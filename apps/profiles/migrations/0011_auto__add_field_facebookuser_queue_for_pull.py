...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacebookUser.queue_for_pull'
        db.add_column('profiles_facebookuser', 'queue_for_pull', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacebookUser.queue_for_pull'
        db.delete_column('profiles_facebookuser', 'queue_for_pull')
