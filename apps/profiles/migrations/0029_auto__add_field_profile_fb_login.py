...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.fb_login'
        db.add_column('profiles_profile', 'fb_login', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.fb_login'
        db.delete_column('profiles_profile', 'fb_login')
    ...
    models = {
        ...
        'profiles.profile': {
            ...
            'fb_login': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'source': ('django.db.models.fields.CharField', [], {'default': "'Direct'", 'max_length': '150'}),
