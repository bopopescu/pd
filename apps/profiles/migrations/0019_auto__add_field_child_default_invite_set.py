...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Child.default_invite_set'
        db.add_column('profiles_child', 'default_invite_set', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Child.default_invite_set'
        db.delete_column('profiles_child', 'default_invite_set')
