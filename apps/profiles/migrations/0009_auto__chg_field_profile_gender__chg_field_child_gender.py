...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.gender'
        db.alter_column('profiles_profile', 'gender', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'Child.gender'
        db.alter_column('profiles_child', 'gender', self.gf('django.db.models.fields.CharField')(max_length=6))


    def backwards(self, orm):
        
        # Changing field 'Profile.gender'
        db.alter_column('profiles_profile', 'gender', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Child.gender'
        db.alter_column('profiles_child', 'gender', self.gf('django.db.models.fields.CharField')(max_length=5))
