...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Profile', fields ['last_name']
        db.create_index('profiles_profile', ['last_name'])

        # Adding index on 'Profile', fields ['first_name']
        db.create_index('profiles_profile', ['first_name'])

        # Adding index on 'Profile', fields ['zip_code']
        db.create_index('profiles_profile', ['zip_code'])

        # Adding index on 'Child', fields ['last_name']
        db.create_index('profiles_child', ['last_name'])

        # Adding index on 'Child', fields ['first_name']
        db.create_index('profiles_child', ['first_name'])


    def backwards(self, orm):
        
        # Removing index on 'Child', fields ['first_name']
        db.delete_index('profiles_child', ['first_name'])

        # Removing index on 'Child', fields ['last_name']
        db.delete_index('profiles_child', ['last_name'])

        # Removing index on 'Profile', fields ['zip_code']
        db.delete_index('profiles_profile', ['zip_code'])

        # Removing index on 'Profile', fields ['first_name']
        db.delete_index('profiles_profile', ['first_name'])

        # Removing index on 'Profile', fields ['last_name']
        db.delete_index('profiles_profile', ['last_name'])
    ...
    models = {
        ...
        'profiles.profile': {
            ...
            'zip_code': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '5', 'null': 'True', 'blank': 'True'})
        },
        'schools.school': {
