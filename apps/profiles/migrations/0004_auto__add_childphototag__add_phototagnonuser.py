...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ChildPhotoTag'
        db.create_table('profiles_childphototag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tagged_children', to=orm['photos.Photo'])),
            ('child', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tagged_photos', to=orm['profiles.Child'])),
        ))
        db.send_create_signal('profiles', ['ChildPhotoTag'])

        # Adding model 'PhotoTagNonUser'
        db.create_table('profiles_phototagnonuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tagged_nonusers', to=orm['photos.Photo'])),
            ('nonuser', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('profiles', ['PhotoTagNonUser'])


    def backwards(self, orm):
        
        # Deleting model 'ChildPhotoTag'
        db.delete_table('profiles_childphototag')

        # Deleting model 'PhotoTagNonUser'
        db.delete_table('profiles_phototagnonuser')
    ...
    models = {
        ...
        'photos.album': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'albums'", 'to': "orm['auth.User']"}),
