...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EventPlan'
        db.create_table('schedule_eventplan', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('child', self.gf('django.db.models.fields.related.ForeignKey')(related_name='events', to=orm['profiles.Child'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='children', to=orm['schedule.Event'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='1', max_length=1)),
        ))
        db.send_create_signal('schedule', ['EventPlan'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EventPlan'
        db.delete_table('schedule_eventplan')
