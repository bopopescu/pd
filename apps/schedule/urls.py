...
urlpatterns = patterns('',
     url(r"^view/(?P<child_id>\d+)/$", "schedule.views.view_calendar", name="view_calendar", kwargs={'periods': [Week] }),
     url(r"^view/$", "schedule.views.view_calendar", name="view_calendar", kwargs={'periods': [Week] }),
     url(r"^get_events/(?P<child_id>\d+)/$", "schedule.views.get_events", name="get_events"),
     url(r"^new_event/(?P<child_id>\d+)/$", "schedule.views.new_event", name="new_event"),
     url(r"^delete_event/(?P<child_id>\d+)/$", "schedule.views.delete_event", name="delete_event"),
     url(r"^authgcal/$", "schedule.views.authsub_login", name="gcal_auth"),
