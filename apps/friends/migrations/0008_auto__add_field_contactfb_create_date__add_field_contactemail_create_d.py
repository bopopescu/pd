...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactFB.create_date'
        db.add_column('friends_contactfb', 'create_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True), keep_default=False)

        # Adding field 'ContactEmail.create_date'
        db.add_column('friends_contactemail', 'create_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContactFB.create_date'
        db.delete_column('friends_contactfb', 'create_date')

        # Deleting field 'ContactEmail.create_date'
        db.delete_column('friends_contactemail', 'create_date')
