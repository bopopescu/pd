...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactEmail.import_job'
        db.add_column('friends_contactemail', 'import_job', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContactEmail.import_job'
        db.delete_column('friends_contactemail', 'import_job')
