...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactFB.removed'
        db.add_column('friends_contactfb', 'removed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ContactEmail.removed'
        db.add_column('friends_contactemail', 'removed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContactFB.removed'
        db.delete_column('friends_contactfb', 'removed')

        # Deleting field 'ContactEmail.removed'
        db.delete_column('friends_contactemail', 'removed')
