...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactFB.invited'
        db.add_column('friends_contactfb', 'invited', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'ContactEmail.invited'
        db.add_column('friends_contactemail', 'invited', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContactFB.invited'
        db.delete_column('friends_contactfb', 'invited')

        # Deleting field 'ContactEmail.invited'
        db.delete_column('friends_contactemail', 'invited')
    ...
    models = {
        ...
        'friends.contactemail': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invited': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
