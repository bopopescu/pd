...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'JoinInvitationEmail'
        db.create_table('friends_joininvitationemail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='join_from', to=orm['auth.User'])),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['friends.ContactEmail'])),
        ...
        db.send_create_signal('friends', ['JoinInvitationEmail'])

        # Adding model 'ContactFB'
        db.create_table('friends_contactfb', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contactfb_related', to=orm['auth.User'])),
        ...
        db.send_create_signal('friends', ['ContactFB'])

        # Adding unique constraint on 'ContactFB', fields ['owner', 'facebook_id']
        db.create_unique('friends_contactfb', ['owner_id', 'facebook_id'])

        # Adding model 'ContactEmail'
        db.create_table('friends_contactemail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contactemail_related', to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('added', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
        ...
        db.send_create_signal('friends', ['ContactEmail'])

        # Adding unique constraint on 'ContactEmail', fields ['owner', 'email']
        db.create_unique('friends_contactemail', ['owner_id', 'email'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ContactEmail', fields ['owner', 'email']
        db.delete_unique('friends_contactemail', ['owner_id', 'email'])

        # Removing unique constraint on 'ContactFB', fields ['owner', 'facebook_id']
        db.delete_unique('friends_contactfb', ['owner_id', 'facebook_id'])
        ...
        # Deleting model 'JoinInvitationEmail'
        db.delete_table('friends_joininvitationemail')

        # Deleting model 'ContactFB'
        db.delete_table('friends_contactfb')

        # Deleting model 'ContactEmail'
        db.delete_table('friends_contactemail')
    ...
    models = {
        ...
        'friends.contactemail': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contactemail_related'", 'to': "orm['auth.User']"}),
        ...
        'friends.contactfb': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contactfb_related'", 'to': "orm['auth.User']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
