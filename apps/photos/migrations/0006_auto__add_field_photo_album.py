...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('photos_photo', 'album', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='photos', to=orm['photos.Album']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('photos_photo', 'album_id')
