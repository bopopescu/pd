...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('photos_photo', 'caption', self.gf('django.db.models.fields.CharField')(max_length=201))

        # Changing field 'Album.title'
        db.alter_column('photos_album', 'title', self.gf('django.db.models.fields.CharField')(max_length=101))


    def backwards(self, orm):
        
        # Changing field 'Photo.caption'
        db.alter_column('photos_photo', 'caption', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Album.title'
        db.alter_column('photos_album', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
