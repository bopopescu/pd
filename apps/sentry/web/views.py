...
REQUIRED_EMAIL = getattr(django_settings, "ACCOUNT_REQUIRED_EMAIL", False)
EMAIL_VERIFICATION = getattr(django_settings, "ACCOUNT_EMAIL_VERIFICATION", False)
EMAIL_AUTHENTICATION = getattr(django_settings, "ACCOUNT_EMAIL_AUTHENTICATION", False)
UNIQUE_EMAIL = getattr(django_settings, "ACCOUNT_UNIQUE_EMAIL", False)
...
#        super(AuthenticationForm, self).__init__(*args, **kwargs)
    ...
    def __init__(self, request=None, *args, **kwargs):
        ...
        if EMAIL_AUTHENTICATION:
            tolog("yes to email authentication")
    ...
    def clean(self):
        if self._errors:
            return
        self.user_cache = authenticate(**self.user_credentials())
