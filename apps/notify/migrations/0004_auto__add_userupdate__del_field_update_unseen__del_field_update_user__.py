...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notify_userupdate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='updates', to=orm['auth.User'])),
            ('update', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['notify.Update'], unique=True)),
            ('unseen', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('archived', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('notify', ['UserUpdate'])

        # Deleting field 'Update.unseen'
        db.delete_column('notify_update', 'unseen')

        # Deleting field 'Update.user'
        db.delete_column('notify_update', 'user_id')

        # Adding field 'Update.owner'
        db.add_column('notify_update', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='my_updates', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'UserUpdate'
        db.delete_table('notify_userupdate')

        # Adding field 'Update.unseen'
        db.add_column('notify_update', 'unseen', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Update.user'
        db.add_column('notify_update', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='updates', to=orm['auth.User']), keep_default=False)

        # Deleting field 'Update.owner'
        db.delete_column('notify_update', 'owner_id')
    ...
    models = {
        ...
        'notify.userupdate': {
            ...
            'update': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['notify.Update']", 'unique': 'True'}),
