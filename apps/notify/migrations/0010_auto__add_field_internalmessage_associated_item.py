...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InternalMessage.associated_item'
        db.add_column('notify_internalmessage', 'associated_item', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InternalMessage.associated_item'
        db.delete_column('notify_internalmessage', 'associated_item')
