...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InternalMessage.message_type'
        db.delete_column('notify_internalmessage', 'message_type')

        # Adding field 'InternalMessage.category'
        db.add_column('notify_internalmessage', 'category', self.gf('django.db.models.fields.CharField')(default='Message', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'InternalMessage.message_type'
        db.add_column('notify_internalmessage', 'message_type', self.gf('django.db.models.fields.CharField')(default='M', max_length=1), keep_default=False)

        # Deleting field 'InternalMessage.category'
        db.delete_column('notify_internalmessage', 'category')
