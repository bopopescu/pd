...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InternalMessage.parent_msg'
        db.delete_column('notify_internalmessage', 'parent_msg_id')


    def backwards(self, orm):
        
        # Adding field 'InternalMessage.parent_msg'
        db.add_column('notify_internalmessage', 'parent_msg', self.gf('django.db.models.fields.related.ForeignKey')(related_name='next_messages', null=True, to=orm['notify.InternalMessage'], blank=True), keep_default=False)
