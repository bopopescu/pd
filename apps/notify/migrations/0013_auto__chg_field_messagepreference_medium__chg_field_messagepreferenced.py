...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MessagePreference.medium'
        db.alter_column('notify_messagepreference', 'medium', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'MessagePreferenceDefaults.medium'
        db.alter_column('notify_messagepreferencedefaults', 'medium', self.gf('django.db.models.fields.CharField')(max_length=10))


    def backwards(self, orm):
        
        # Changing field 'MessagePreference.medium'
        db.alter_column('notify_messagepreference', 'medium', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'MessagePreferenceDefaults.medium'
        db.alter_column('notify_messagepreferencedefaults', 'medium', self.gf('django.db.models.fields.CharField')(max_length=1))
