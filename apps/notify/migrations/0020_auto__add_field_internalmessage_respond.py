...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InternalMessage.respond'
        db.add_column('notify_internalmessage', 'respond', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InternalMessage.respond'
        db.delete_column('notify_internalmessage', 'respond')
    ...
    models = {
        ...
        'notify.internalmessage': {
            ...
            'respond': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
