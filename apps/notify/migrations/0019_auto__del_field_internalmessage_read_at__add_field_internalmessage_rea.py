...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InternalMessage.read_at'
        db.delete_column('notify_internalmessage', 'read_at')

        # Adding field 'InternalMessage.read_at_sender'
        db.add_column('notify_internalmessage', 'read_at_sender', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'InternalMessage.read_at_recipient'
        db.add_column('notify_internalmessage', 'read_at_recipient', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'InternalMessage.read_at'
        db.add_column('notify_internalmessage', 'read_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Deleting field 'InternalMessage.read_at_sender'
        db.delete_column('notify_internalmessage', 'read_at_sender')

        # Deleting field 'InternalMessage.read_at_recipient'
        db.delete_column('notify_internalmessage', 'read_at_recipient')
    ...
    models = {
        ...
        'notify.internalmessage': {
            ...
            'read_at_recipient': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'read_at_sender': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
