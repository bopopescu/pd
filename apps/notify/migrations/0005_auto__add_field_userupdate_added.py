...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserUpdate.added'
        db.add_column('notify_userupdate', 'added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserUpdate.added'
        db.delete_column('notify_userupdate', 'added')
