...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MessagePreference.type'
        db.alter_column('notify_messagepreference', 'type', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'MessagePreferenceDefaults.type'
        db.alter_column('notify_messagepreferencedefaults', 'type', self.gf('django.db.models.fields.CharField')(max_length=40))


    def backwards(self, orm):
        
        # Changing field 'MessagePreference.type'
        db.alter_column('notify_messagepreference', 'type', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'MessagePreferenceDefaults.type'
        db.alter_column('notify_messagepreferencedefaults', 'type', self.gf('django.db.models.fields.CharField')(max_length=20))
