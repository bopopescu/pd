...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('notify_internalmessage', 'parent_msg', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InternalMessage.parent_msg'
        db.delete_column('notify_internalmessage', 'parent_msg')
