...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'MessagePreferenceDefaults', fields ['medium', 'type']
        db.delete_unique('notify_messagepreferencedefaults', ['medium', 'type'])

        # Removing unique constraint on 'MessagePreference', fields ['medium', 'type', 'user']
        db.delete_unique('notify_messagepreference', ['medium', 'type', 'user_id'])

        # Deleting field 'MessagePreference.medium'
        db.delete_column('notify_messagepreference', 'medium')

        # Adding unique constraint on 'MessagePreference', fields ['type', 'user']
        db.create_unique('notify_messagepreference', ['type', 'user_id'])

        # Deleting field 'MessagePreferenceDefaults.medium'
        db.delete_column('notify_messagepreferencedefaults', 'medium')

        # Adding unique constraint on 'MessagePreferenceDefaults', fields ['type']
        db.create_unique('notify_messagepreferencedefaults', ['type'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'MessagePreferenceDefaults', fields ['type']
        db.delete_unique('notify_messagepreferencedefaults', ['type'])

        # Removing unique constraint on 'MessagePreference', fields ['type', 'user']
        db.delete_unique('notify_messagepreference', ['type', 'user_id'])

        # Adding field 'MessagePreference.medium'
        db.add_column('notify_messagepreference', 'medium', self.gf('django.db.models.fields.CharField')(default=1, max_length=10), keep_default=False)

        # Adding unique constraint on 'MessagePreference', fields ['medium', 'type', 'user']
        db.create_unique('notify_messagepreference', ['medium', 'type', 'user_id'])

        # Adding field 'MessagePreferenceDefaults.medium'
        db.add_column('notify_messagepreferencedefaults', 'medium', self.gf('django.db.models.fields.CharField')(default=1, max_length=10), keep_default=False)

        # Adding unique constraint on 'MessagePreferenceDefaults', fields ['medium', 'type']
        db.create_unique('notify_messagepreferencedefaults', ['medium', 'type'])
