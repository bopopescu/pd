...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MessageContent.type'
        db.alter_column('notify_messagecontent', 'type', self.gf('django.db.models.fields.CharField')(max_length=40))


    def backwards(self, orm):
        
        # Changing field 'MessageContent.type'
        db.alter_column('notify_messagecontent', 'type', self.gf('django.db.models.fields.CharField')(max_length=20))
