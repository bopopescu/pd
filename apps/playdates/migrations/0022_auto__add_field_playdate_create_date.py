...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Playdate.create_date'
        db.add_column('playdates_playdate', 'create_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Playdate.create_date'
        db.delete_column('playdates_playdate', 'create_date')
