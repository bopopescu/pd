...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Playdate.message'
        db.delete_column('playdates_playdate', 'message')

        # Adding field 'Playdate.details'
        db.add_column('playdates_playdate', 'details', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Playdate.message'
        db.add_column('playdates_playdate', 'message', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Playdate.details'
        db.delete_column('playdates_playdate', 'details')
