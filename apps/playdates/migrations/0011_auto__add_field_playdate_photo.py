...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Playdate.photo'
        db.add_column('playdates_playdate', 'photo', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['photos.Photo'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Playdate.photo'
        db.delete_column('playdates_playdate', 'photo_id')
