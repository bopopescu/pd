...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlaydateInviteUser.pickup_details'
        db.add_column('playdates_playdateinviteuser', 'pickup_details', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True), keep_default=False)

        # Adding field 'PlaydateInviteFB.pickup_details'
        db.add_column('playdates_playdateinvitefb', 'pickup_details', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True), keep_default=False)

        # Adding field 'PlaydateInviteEmail.pickup_details'
        db.add_column('playdates_playdateinviteemail', 'pickup_details', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlaydateInviteUser.pickup_details'
        db.delete_column('playdates_playdateinviteuser', 'pickup_details')

        # Deleting field 'PlaydateInviteFB.pickup_details'
        db.delete_column('playdates_playdateinvitefb', 'pickup_details')

        # Deleting field 'PlaydateInviteEmail.pickup_details'
        db.delete_column('playdates_playdateinviteemail', 'pickup_details')
    ...
    models = {
        ...
        'playdates.playdateinviteemail': {
            ...
            'pickup_details': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
