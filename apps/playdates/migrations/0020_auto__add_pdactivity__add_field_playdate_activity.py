...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PDActivity'
        db.create_table('playdates_pdactivity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('playdates', ['PDActivity'])

        # Adding field 'Playdate.activity'
        db.add_column('playdates_playdate', 'activity', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['playdates.PDActivity']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'PDActivity'
        db.delete_table('playdates_pdactivity')

        # Deleting field 'Playdate.activity'
        db.delete_column('playdates_playdate', 'activity_id')
    ...
    models = {
        ...
        'playdates.pdactivity': {
            'Meta': {'object_name': 'PDActivity'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'playdates.playdate': {
            'Meta': {'object_name': 'Playdate'},
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['playdates.PDActivity']"}),
