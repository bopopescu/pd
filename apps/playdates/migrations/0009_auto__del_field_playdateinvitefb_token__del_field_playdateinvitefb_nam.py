...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PlaydateInviteFB.token'
        db.delete_column('playdates_playdateinvitefb', 'token')

        # Deleting field 'PlaydateInviteFB.name'
        db.delete_column('playdates_playdateinvitefb', 'name')


    def backwards(self, orm):
        
        # Adding field 'PlaydateInviteFB.token'
        db.add_column('playdates_playdateinvitefb', 'token', self.gf('django.db.models.fields.CharField')(default='funk', max_length=30), keep_default=False)

        # Adding field 'PlaydateInviteFB.name'
        db.add_column('playdates_playdateinvitefb', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)
