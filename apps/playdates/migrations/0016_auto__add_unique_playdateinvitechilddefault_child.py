...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'PlaydateInviteChildDefault', fields ['child']
        db.create_unique('playdates_playdateinvitechilddefault', ['child_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PlaydateInviteChildDefault', fields ['child']
        db.delete_unique('playdates_playdateinvitechilddefault', ['child_id'])
    ...
    models = {
        ...
        'playdates.playdateinvitechilddefault': {
            ...
            'child': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'default_invite'", 'unique': 'True', 'to': "orm['profiles.Child']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
