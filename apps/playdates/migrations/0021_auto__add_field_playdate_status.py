...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Playdate.status'
        db.add_column('playdates_playdate', 'status', self.gf('django.db.models.fields.CharField')(default='1', max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Playdate.status'
        db.delete_column('playdates_playdate', 'status')
