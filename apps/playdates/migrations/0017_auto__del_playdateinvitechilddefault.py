...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('playdates_playdateinvitechilddefault', (
            ('invite_design', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['playdates.InviteDesign'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('child', self.gf('django.db.models.fields.related.ForeignKey')(related_name='default_invite', unique=True, to=orm['profiles.Child'])),
        ))
