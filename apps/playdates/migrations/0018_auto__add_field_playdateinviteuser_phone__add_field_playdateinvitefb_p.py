...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlaydateInviteUser.phone'
        db.add_column('playdates_playdateinviteuser', 'phone', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)

        # Adding field 'PlaydateInviteFB.phone'
        db.add_column('playdates_playdateinvitefb', 'phone', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)

        # Adding field 'PlaydateInviteEmail.phone'
        db.add_column('playdates_playdateinviteemail', 'phone', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlaydateInviteUser.phone'
        db.delete_column('playdates_playdateinviteuser', 'phone')

        # Deleting field 'PlaydateInviteFB.phone'
        db.delete_column('playdates_playdateinvitefb', 'phone')

        # Deleting field 'PlaydateInviteEmail.phone'
        db.delete_column('playdates_playdateinviteemail', 'phone')
