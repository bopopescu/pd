...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlaydateInviteUser.organizer_child'
        db.add_column('playdates_playdateinviteuser', 'organizer_child', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='my_user_invitees', to=orm['profiles.Child']), keep_default=False)

        # Deleting field 'Playdate.organizer_child'
        db.delete_column('playdates_playdate', 'organizer_child_id')

        # Adding field 'PlaydateInviteEmail.organizer_child'
        db.add_column('playdates_playdateinviteemail', 'organizer_child', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='my_email_invitees', to=orm['profiles.Child']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlaydateInviteUser.organizer_child'
        db.delete_column('playdates_playdateinviteuser', 'organizer_child_id')

        # Adding field 'Playdate.organizer_child'
        db.add_column('playdates_playdate', 'organizer_child', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['profiles.Child']), keep_default=False)

        # Deleting field 'PlaydateInviteEmail.organizer_child'
        db.delete_column('playdates_playdateinviteemail', 'organizer_child_id')
