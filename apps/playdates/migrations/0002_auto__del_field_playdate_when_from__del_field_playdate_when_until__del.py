...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Playdate', fields ['when_until', 'when_from', 'organizer_child']
        db.delete_unique('playdates_playdate', ['when_until', 'when_from', 'organizer_child_id'])

        # Deleting field 'Playdate.when_from'
        db.delete_column('playdates_playdate', 'when_from')

        # Deleting field 'Playdate.when_until'
        db.delete_column('playdates_playdate', 'when_until')


    def backwards(self, orm):
        
        # Adding field 'Playdate.when_from'
        db.add_column('playdates_playdate', 'when_from', self.gf('django.db.models.fields.DateTimeField')(default=1), keep_default=False)

        # Adding field 'Playdate.when_until'
        db.add_column('playdates_playdate', 'when_until', self.gf('django.db.models.fields.DateTimeField')(default=2), keep_default=False)

        # Adding unique constraint on 'Playdate', fields ['when_until', 'when_from', 'organizer_child']
        db.create_unique('playdates_playdate', ['when_until', 'when_from', 'organizer_child_id'])
