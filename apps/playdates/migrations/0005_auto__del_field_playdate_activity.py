...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('playdates_playdate', 'activity')


    def backwards(self, orm):
        
        # Adding field 'Playdate.activity'
        db.add_column('playdates_playdate', 'activity', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
