...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Playdate.album'
        db.add_column('playdates_playdate', 'album', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['photos.Album']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Playdate.album'
        db.delete_column('playdates_playdate', 'album_id')
