...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlaydateInviteFB'
        db.create_table('playdates_playdateinvitefb', (
            ...
            ('playdate', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fb_invites', to=orm['playdates.Playdate'])),
            ('facebook_contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['friends.ContactFB'])),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('organizer_child', self.gf('django.db.models.fields.related.ForeignKey')(related_name='my_fb_invitees', to=orm['profiles.Child'])),
        ))
        db.send_create_signal('playdates', ['PlaydateInviteFB'])

        # Adding unique constraint on 'PlaydateInviteFB', fields ['playdate', 'facebook_contact']
        db.create_unique('playdates_playdateinvitefb', ['playdate_id', 'facebook_contact_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PlaydateInviteFB', fields ['playdate', 'facebook_contact']
        db.delete_unique('playdates_playdateinvitefb', ['playdate_id', 'facebook_contact_id'])

        # Deleting model 'PlaydateInviteFB'
        db.delete_table('playdates_playdateinvitefb')
