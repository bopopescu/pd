...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('playdates_playdate', 'invite_design_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['playdates.InviteDesign'], null=True))

        # Adding field 'InviteDesign.subject'
        db.add_column('playdates_invitedesign', 'subject', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=140, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'InviteDesign.subject'
        db.delete_column('playdates_invitedesign', 'subject')
