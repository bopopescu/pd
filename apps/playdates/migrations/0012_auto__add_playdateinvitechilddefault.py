...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlaydateInviteChildDefault'
        db.create_table('playdates_playdateinvitechilddefault', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('child', self.gf('django.db.models.fields.related.ForeignKey')(related_name='default_invite', to=orm['profiles.Child'])),
            ('invite_design', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['playdates.PlaydateInviteDesign'])),
        ))
        db.send_create_signal('playdates', ['PlaydateInviteChildDefault'])


    def backwards(self, orm):
        
        # Deleting model 'PlaydateInviteChildDefault'
        db.delete_table('playdates_playdateinvitechilddefault')
    ...
    models = {
        ...
        'playdates.playdateinvitechilddefault': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_design': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['playdates.PlaydateInviteDesign']"})
        },
