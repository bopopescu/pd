...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InviteDesign'
        db.create_table('playdates_invitedesign', (
        ...
        db.send_create_signal('playdates', ['InviteDesign'])

        # Changing field 'Playdate.invite_design'
        db.alter_column('playdates_playdate', 'invite_design_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['playdates.InviteDesign']))

        # Changing field 'PlaydateInviteChildDefault.invite_design'
        db.alter_column('playdates_playdateinvitechilddefault', 'invite_design_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['playdates.InviteDesign']))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'InviteDesign'
        db.delete_table('playdates_invitedesign')

        # Changing field 'Playdate.invite_design'
        db.alter_column('playdates_playdate', 'invite_design_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['playdates.PlaydateInviteDesign']))

        # Changing field 'PlaydateInviteChildDefault.invite_design'
        db.alter_column('playdates_playdateinvitechilddefault', 'invite_design_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['playdates.PlaydateInviteDesign']))
    ...
    models = {
        ...
        'playdates.playdate': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_design': ('django.db.models.fields.related.ForeignKey', [], {'default': "'Basic'", 'to': "orm['playdates.InviteDesign']"}),
