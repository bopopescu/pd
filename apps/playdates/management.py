...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background:#fff; color:#7b7b7b;">
  <tr>
    <td align="center"><table width="476" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td style="font-size:16px; line-height:20px; font-family:Arial, Helvetica, sans-serif; text-align:center;"><strong style="color:#043351;">{{ actor.first_name }} {{ actor.last_name }} </strong> sent you an invitation on behalf of {{ actor_child.first_name }}. <br />
              ...
              <tr>
                ...
                <td width="266"><table width="266" border="0" cellspacing="0" cellpadding="0" style="color:#404040;">
                    <tr>
                      ...
                      <td style="font-family:Tahoma, Geneva, sans-serif; width:190px; font-weight:bold; font-size:11px; height:14px; line-height:14px;">{{ actor.first_name }} is organizing an activity </td>
                    </tr>
                    <tr>
        ...
        <td align="center" valign="top"><table width="600" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td><table width="600" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td style=" text-align:center; font-size:14px; color:#7b7b7b; line-height:18px; font-family:Arial, Helvetica, sans-serif;"><font style=" color:#043351; font-weight:bold;">{{ actor.first_name }} {{ actor.last_name }}s</font> sent you an invitation on behalf of {{ actor_child.first_name }}.<br />
                                     Click <a href="{{playdate_url}}" style="color:#fb8d3a; text-decoration:none;">here</a> to view your invitation! </td>
                            </tr>
                            <tr>
                                <td height="19"></td>
                ...
                <tr>
                    <td><table width="600" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td valign="bottom"><img src="http://"""+settings.WWW_HOST+"""/static/images/email/kids/img_top.png" width="600" height="192" alt="" style="border:0; padding:0; margin:0; vertical-align:bottom;" /></td>
                            </tr>
                            <tr>
                                <td><table width="600" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td height="87" width="164"><img src="http://"""+settings.WWW_HOST+"""/static/images/email/kids/img_left.png" width="164" height="87" alt="" style="margin:0; padding:0; border:0; vertical-align:top;" /></td>
                                            <td width="285" height="87" style="background:#fdeb6b;"><table width="285" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td style="font-family:Georgia, 'Times New Roman', Times, serif; font-style:italic; font-size:12px; padding:0 0 0 55px; text-align:left; color:#8b7c53;">{% if email %}{%else%}for you{%endif%}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style=" font-family:Georgia, 'Times New Roman', Times, serif; font-size:40px; font-style:italic; text-align:left; padding:0 0 0 70px; color:#a77130;">{% if email %}Your Child{% else %}{{ actee_child.first_name }}{% endif %}</td>
                                                    </tr>
                                                </table></td>
                                            <td height="87" width="151"><img src="http://"""+settings.WWW_HOST+"""/static/images/email/kids/img_right.png" width="151" height="87" alt="" style="margin:0; padding:0; border:0; vertical-align:top;" /></td>
                                        </tr>
                                    </table></td>
                            </tr>
                            <tr>
                                <td valign="top"><img src="http://"""+settings.WWW_HOST+"""/static/images/email/kids/img_bottom.png" width="600" height="120" alt="" style="margin:0; padding:0; border:0; vertical-align:top;" /></td>
                            </tr>
                        </table></td>
                </tr>
                <tr>
                    <td><table width="600" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td align="center"><table width="275" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td valign="middle" align="left" width="75"><img src="http://"""+settings.WWW_HOST+"""/static/images/email/kids/img_email.png" width="66" height="47" alt="" style="margin:0; padding:0; border:0; vertical-align:middle;" /></td>
                                            <td width="200"><table width="200" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td style="font-family:Tahoma, Geneva, sans-serif; font-size:11px; font-weight:bold; color:#404040; text-align:left;">{{ actor.first_name }} is organizing an activity</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-family:Tahoma, Geneva, sans-serif; font-size:11px; color:#404040; text-align:left;">{{ playdate.event.start }}<br />
                                                            At {{ playdate.address }}<br />
                                                            <a href="{{playdate_url}}" style="color:#3f71c3; text-decoration:none;">Details</a></td>
                                                    </tr>
                                                </table></td>
                                        </tr>
                                    </table></td>
                ...
                <tr>
                    <td><table width="600" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td><img src="http://"""+settings.WWW_HOST+"""/static/images/email/kids/img_line.png" width="600" height="25" alt="" style="margin:0; padding:0; border:0; vertical-align:middle;" /></td>
                            </tr>
                            <tr>
                                <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; color:#a9a9a9; text-align:left;">This message is service email related to your use of Playdation. To change your email settings, <a href="http://"""+settings.WWW_HOST+"""/account/settings/communication" style="color:#3f71c3; text-decoration:none;">click here</a></td>
                            </tr>
                            <tr>
                                <td><img src="http://"""+settings.WWW_HOST+"""/static/images/email/kids/img_line.png" width="600" height="25"  alt="" style="margin:0; padding:0; border:0; vertical-align:middle;" /></td>
                            </tr>
                            <tr>
                                <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; color:#a9a9a9; text-align:left;"> Please add <a href="mailto:notification@playdation.com" style="color:#a9a9a9; text-decoration:none;">notification@playdation.com</a> to your address book to ensure deliverability of all future Playdation email. </td>
                            </tr>
                            <tr>
                                <td><img src="http://"""+settings.WWW_HOST+"""/static/images/email/kids/img_line.png" width="600" height="25" alt="" style="margin:0; padding:0; border:0; vertical-align:middle;" /></td>
                            </tr>
...
def create_playdate_invite_designs(app, created_models, verbosity, **kwargs):
    invites.create_playdate_invite_design(title="Male", subject="{% if email %}Your Child{% else %}{{ actee_child.first_name }}{% endif %} has received an invitation!", small_image="http://www.cnn.com", big_image="http://www.cnn.com",description="Basic Male Vanilla Invite",html=content_male )
    invites.create_playdate_invite_design(title="Female", subject="{% if email %}Your Child{% else %}{{ actee_child.first_name }}{% endif %} has received an invitation!", small_image="http://www.cnn.com", big_image="http://www.cnn.com",description="Basic Female Vanilla Invite",html=content_female )
    invites.create_playdate_invite_design(title="Toddler", subject="{% if email %}Your Child{% else %}{{ actee_child.first_name }}{% endif %} has received an invitation!", small_image="http://www.cnn.com", big_image="http://www.cnn.com",description="Basic Vanilla Invite",html=content_kids )
