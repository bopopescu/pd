...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'School.district_name'
        db.add_column('schools_school', 'district_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'School.street'
        db.add_column('schools_school', 'street', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'School.phone'
        db.add_column('schools_school', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'School.level'
        db.add_column('schools_school', 'level', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'School.district_name'
        db.delete_column('schools_school', 'district_name')

        # Deleting field 'School.street'
        db.delete_column('schools_school', 'street')

        # Deleting field 'School.phone'
        db.delete_column('schools_school', 'phone')

        # Deleting field 'School.level'
        db.delete_column('schools_school', 'level')
