...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Zip_School_Prox', fields ['school']
        db.create_index('schools_zip_school_prox', ['school_id'])


    def backwards(self, orm):
        
        # Removing index on 'Zip_School_Prox', fields ['school']
        db.delete_index('schools_zip_school_prox', ['school_id'])
