...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'School.gsurl'
        db.add_column('schools_school', 'gsurl', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'School.url'
        db.add_column('schools_school', 'url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Deleting field 'School.gsurl'
        db.delete_column('schools_school', 'gsurl')
