...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Zip_School_Prox.name'
        db.add_column('schools_zip_school_prox', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Zip_School_Prox.name'
        db.delete_column('schools_zip_school_prox', 'name')
