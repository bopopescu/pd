...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'School.url'
        db.alter_column('schools_school', 'url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'School.url'
        db.alter_column('schools_school', 'url', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
